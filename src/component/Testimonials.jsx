    ...
    <section>
      <div className="max-w-[1400px] px-10 mx-auto py-20">
        ...
        <div className="flex justify-end mt-5 py-5 gap-x-3 ">
          <button className=" custom-prev text-2xl text-zinc-800 rounded-lg w-11 h-11  flex justify-center items-center bg-zinc-100 hover:bg-linear-to-b hover:from-green-400 hover:to-green-500 hover:text-white cursor-pointer">
            <IoIosArrowBack />
          </button>
          <button className=" custom-next text-2xl text-zinc-800 rounded-lg w-11 h-11 flex justify-center items-center bg-zinc-100 hover:bg-linear-to-b hover:from-green-400 hover:to-green-500 hover:text-white cursor-pointer">
            <IoIosArrowForward />
          </button>
        </div>
